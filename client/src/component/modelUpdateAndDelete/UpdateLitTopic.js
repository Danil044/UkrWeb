...
const UpdateLitTopic = observer(() => {
    ...
    useEffect(()=>{
        const getPostTopic = async () =>{
            const res = await axios.get(`${API_URL}/LitTopic/` + path)
    ...
    const handleDelete = async () => {
        try{
            await axios.delete(`${API_URL}/LitTopic/${postTopic._id}`, {
                name
            })
    ...
    const handleUpdate = async () => {
        try {
            await axios.put(`${API_URL}/LitTopic/${postTopic._id}`, {
                name
            })
